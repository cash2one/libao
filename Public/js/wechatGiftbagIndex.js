...
//                    "orderable":false
                    ...
                    "render":function(data, type){
                        return '<a href="importAgain/giftsid/'+data+' " class="center leadingin">'+'追加导入'+'</a>';
                    }
//                    "orderable":false
                },
        	  ...
        	  if($validation) {
                  ...
                  if (!$('#validation-form').valid()) {
                    return false;
                	 ...
                	 if($("#name").val()==''){
                		 window.location.href='news_step2/name/'+$("#gamelist").find("option:selected").text();
                	 }else{
                		 window.location.href='news_step2/name/'+$("#name").val(); 
                	 }
